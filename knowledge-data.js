window.KNOWLEDGE_ITEMS = [
  ...
  },
  {
    ...
    "studyMode": "memory",
    "recordType": "知识点背诵",
    "oneLine": "只背PDF 01中黑色加粗的图灵机、可计算性、图灵测试和图灵奖结论。",
    "mustGroups": [
      {
        "title": "图灵机",
        "lines": [
          "图灵机主要由一条无限长的纸带和一个读写头组成。",
          "图灵机是一个数学模型、思维机器，不是一台实际的计算机。",
          "图灵机证明了通用计算理论，奠定了可计算性理论的基础。"
        ]
      },
      {
        "title": "通用图灵机",
      ...
      },
      {
        ...
        "lines": [
          "图灵是计算机科学的奠基人。",
          "图灵奖由美国计算机学会（ACM）为纪念图灵而创立，是计算机领域最高奖项。"
        ]
      }
    ],
    "mustPatterns": [
    ...
    "understandGroups": [
      {
        "title": "图灵机补充理解",
        "lines": [
          "图灵机的所有可能状态数目有限，并存在停机状态。",
          "一个问题需要一台图灵机，不同问题需要不同图灵机。",
          "图灵机模型影响了读写、算法、程序语言和计算机架构的形成。"
        ]
      },
      {
        "title": "背景资料",
        "lines": [
          "图灵机思想来自1936年论文《论可计算数及其在判定问题中的应用》。",
          "图灵测试来自1950年论文《Computing Machinery and Intelligence》。",
          "PDF列出的华人图灵奖获得者为姚期智。"
        ]
      }
    ],
    ...
    "sourcePdfPath": "./imports/day-01/alan-turing-source.pdf",
    "sourcePdfLabel": "计算机PDF 01 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "只背PDF 01中黑色加粗的图灵机、可计算性、图灵测试和图灵奖结论。",
      "core": [
        "图灵机主要由一条无限长的纸带和一个读写头组成。",
        "图灵机是一个数学模型、思维机器，不是一台实际的计算机。",
        "图灵机证明了通用计算理论，奠定了可计算性理论的基础。",
  ...
  },
  {
    ...
    "studyMode": "memory",
    "recordType": "知识点背诵",
    "oneLine": "只背PDF 02虚线框内的加粗结论。",
    "mustGroups": [
      {
        "title": "贡献",
        "lines": [
          "冯·诺依曼是第一台冯·诺依曼机EDVAC的设计者，首次提出“存储程序控制”原理。"
        ]
      },
      {
        "title": "冯·诺依曼体系结构",
    ...
    "sourcePdfPath": "./imports/day-02/von-neumann-source.pdf",
    "sourcePdfLabel": "计算机PDF 02 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "只背PDF 02虚线框内的加粗结论。",
      "core": [
        "冯·诺依曼是第一台冯·诺依曼机EDVAC的设计者，首次提出“存储程序控制”原理。",
        "计算机由运算器、控制器、存储器、输入设备和输出设备五部分组成。",
        "程序和数据以同等地位存储在内存中，并按地址访问。",
  ...
  },
  {
    ...
    "studyMode": "memory",
    "recordType": "知识点背诵",
    "oneLine": "只背PDF 03中黑色加粗的“第一台、时间、核心特点和代表结论”。",
    "mustGroups": [
      {
        "title": "电子计算机出现前",
        "lines": [
          "算筹是古代中国人发明的世界上最早的计算工具。",
          "许多人认为算盘是最早的数字计算机，珠算口诀是最早的体系化算法。",
          "查尔斯·巴贝奇于1834年发明分析机。",
          "分析机被公认为现代通用电子计算机的雏形。"
        ]
      },
      {
        ...
        "lines": [
          "ENIAC诞生于1946年2月。",
          "ENIAC表明电子计算机时代到来，具有划时代意义。",
          "ENIAC面向科学计算，早期计算机主要用于科学计算。",
          "ENIAC是非冯·诺依曼机，使用十进制编码，没有存储器，未采用“存储程序原理”。"
        ]
      },
      {
        "title": "EDVAC与UNIVAC-I",
        "lines": [
          "EDVAC是世界上第一台冯·诺依曼机，采用“存储程序控制”的设计思想。",
          "UNIVAC-I是世界上第一款批量制造的电子计算机，奠定了计算机工业的基础。"
        ]
      },
      {
        "title": "中国代表计算机",
        "lines": [
          "我国第一台电子计算机M103诞生于1958年8月1日。",
          "我国第一台超级计算机“银河-I”诞生于1983年。",
          "“神威·太湖之光”于2016年投入运行，CPU采用拥有自主知识产权的“申威26010”。"
        ]
      }
    ],
    "mustPatterns": [
    ...
    "understandGroups": [
      {
        "title": "机型补充",
        "lines": [
          "ENIAC、EDVAC、UNIVAC-I均使用电子管，属于第一代计算机。",
          "UNIVAC-I主要面向公众领域的数据处理和商用。",
          "“神威·太湖之光”的运算量级和其他曾登顶机型只作了解。"
        ]
      },
      {
        "title": "算盘补充",
        "lines": [
          "算盘珠可承担输入和存储作用，珠算口诀类似控制指令，但算盘无法自动运行。"
        ]
      }
    ],
    "understandOnly": [
    ...
    "sourcePdfPath": "./imports/day-03/computer-pdf/computer-basic-03-famous-computers.pdf",
    "sourcePdfLabel": "计算机PDF 03 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "只背PDF 03中黑色加粗的“第一台、时间、核心特点和代表结论”。",
      "core": [
        "算筹是古代中国人发明的世界上最早的计算工具。",
        "许多人认为算盘是最早的数字计算机，珠算口诀是最早的体系化算法。",
        "查尔斯·巴贝奇于1834年发明分析机。",
  ...
  },
  {
    ...
    "studyMode": "memory",
    "recordType": "知识点背诵",
    "oneLine": "只背PDF 04中加粗的各代核心器件、软件标志和分代依据。",
    "mustGroups": [
      {
        "title": "第一代",
        "lines": [
      ...
      },
      {
        ...
        "lines": [
          "第二代是晶体管时代。",
          "第二代出现高级程序设计语言，第一个高级程序设计语言是Fortran。"
        ]
      },
      {
        "title": "第三代",
        "lines": [
          "第三代是中小规模集成电路时代。",
          "第三代出现操作系统，第一个经典的分时操作系统是Unix（1971年）。"
        ]
      },
      {
        "title": "第四代",
        "lines": [
          "第四代是大规模与超大规模集成电路时代。",
          "第四代硬件采用大规模与超大规模集成电路，软件出现数据库系统。",
          "LSI表示大规模集成电路，VLSI表示超大规模集成电路。",
          "1971年Intel 4004微处理器诞生，标志计算机进入第四代。"
        ]
      },
      {
        "title": "分代结论",
        "lines": [
          "计算机分代的依据是主机部分采用的物理器件不同。",
          "目前计算机仍处于第四代，体系结构没有大的突破，仍属于冯·诺依曼机。"
        ]
      }
    ],
    "mustPatterns": [
    ...
    "understandGroups": [
      {
        "title": "时间和代表机型",
        "lines": [
          "各代具体起止时间、代表机型以及第五代研究目标只作了解。",
          "第一代代表有ENIAC、EDVAC、UNIVAC-I；第三代代表有IBM 360。"
        ]
      },
      {
        "title": "集成电路补充",
        "lines": [
          "IC、SSI、MSI等英文缩写和规模分类只作了解。"
        ]
      }
    ],
    "understandOnly": [
    ...
    "sourcePdfPath": "./imports/day-03/computer-pdf/computer-basic-04-development-stages.pdf",
    "sourcePdfLabel": "计算机PDF 04 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "只背PDF 04中加粗的各代核心器件、软件标志和分代依据。",
      "core": [
        "第一代是电子管时代。",
        "第一代软件以机器语言和汇编语言为主。",
        "第二代是晶体管时代。",
  ...
  },
  {
    ...
    "studyMode": "memory",
    "recordType": "知识点背诵",
    "oneLine": "只背PDF 05中黑色加粗的特点名称和本质结论。",
    "mustGroups": [
      {
        "title": "六项特点",
        "lines": [
    ...
    "understandGroups": [
      {
        "title": "概念和解释",
        "lines": [
          "计算机概念、CPU、存储设备、布尔代数、门电路和用户界面的说明只作理解。",
          "逻辑判断能力是计算机智能化的基本条件。"
        ]
      }
    ],
    ...
    "sourcePdfPath": "./imports/day-12/allround-computer/comp-05-characteristics.pdf",
    "sourcePdfLabel": "计算机PDF 05 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "只背PDF 05中黑色加粗的特点名称和本质结论。",
      "core": [
        "计算机运算速度快、精度高。",
        "计算机具备存储能力。",
        "计算机具备逻辑判断能力。",
  ...
  },
  {
    ...
    "studyMode": "memory",
    "recordType": "知识点背诵",
    "oneLine": "只背PDF 06黑色加粗的分类名称、定义和嵌入式核心结论。",
    "mustGroups": [
      {
        "title": "按用途",
        "lines": [
      ...
      },
      {
        "title": "按性能",
        "lines": [
          "高性能计算机中的巨型机即超级计算机，主要用于科研和军事。",
          "服务器是在网络环境中对外提供服务的高性能计算机。",
          "工作站是高端的通用微型计算机，性能强于个人计算机。",
          "PC是Personal Computer，即个人电脑。",
          "微型计算机包括桌面型电脑、笔记本、平板电脑和移动设备。"
        ]
      },
      {
        "title": "嵌入式计算机",
        "lines": [
          "嵌入式计算机是作为信息处理部件嵌入应用系统中的计算机。",
          "单片机把运算器、控制器、存储器、输入输出设备和软件系统集成在一个芯片上，是嵌入式系统的基础。",
          "嵌入式计算机软件与硬件一体化，应用最广泛，数量超过PC。"
        ]
      }
    ],
    "mustPatterns": [
    ...
    "understandGroups": [
      {
        ...
        "lines": [
          "通用机与专用机的具体能力差异只作理解。",
          "大中小型机、服务器软件类型和工作站图形处理优势的补充说明只作了解。",
          "个人电脑的历史、家庭办公用途和兼容性只作了解。"
        ]
      }
    ],
    "understandOnly": [
    ...
    "sourcePdfPath": "./imports/day-12/allround-computer/comp-06-classification.pdf",
    "sourcePdfLabel": "计算机PDF 06 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "只背PDF 06黑色加粗的分类名称、定义和嵌入式核心结论。",
      "core": [
        "计算机按用途分为通用机和专用机。",
        "高性能计算机中的巨型机即超级计算机，主要用于科研和军事。",
        "服务器是在网络环境中对外提供服务的高性能计算机。",
  ...
  },
  {
    ...
    "studyMode": "memory",
    "recordType": "知识点背诵",
    "oneLine": "只背PDF 07中黑色加粗的应用别名、核心定义、加粗缩写和标志事件。",
    "mustGroups": [
      {
        "title": "科学计算与数据处理",
        "lines": [
          "科学计算又称数值计算，科研和军事是其主要领域，也是计算机最早的应用领域。",
          "数据处理又称非数值计算或事务处理，主要用于商业领域。"
        ]
      },
      {
        "title": "过程控制",
        "lines": [
          "过程控制是对压力、液位、流量、温度等参数进行采集与处理的技术。",
          "过程控制主要采用实时操作系统，是自动化技术的重要组成部分。"
        ]
      },
      {
        "title": "辅助工程",
        "lines": [
          "CAD是Computer Aided Design，即计算机辅助设计。",
          "CAI是Computer Aided Instruction，即计算机辅助教学。",
          "CBE是Computer Based Education，即计算机辅助教育或计算机化教育。",
          "CAM是Computer Aided Manufacturing，即计算机辅助制造。",
          "CIMS是Computer Integrated Manufacturing System，即计算机集成制造系统。"
        ]
      },
      {
        "title": "多媒体、网络与人工智能",
        "lines": [
          "多媒体包含文本、音频、视频、动画等多种媒体形式。",
          "多媒体技术以计算机技术为核心，将现代声像技术和通信技术融为一体。",
          "Internet是国际互联网，是全球范围内最大的计算机网络。",
          "IoT是Internet of Things，实现物与物、物与人、人与人之间的万物互连。",
          "Artificial Intelligence（AI）指用计算机模拟人类智能，实现人工智能的根本途径是机器学习（ML）。"
        ]
      },
      {
        "title": "人工智能标志事件",
        "lines": [
          "2016年AlphaGo击败李世石。",
          "2017年AlphaGo击败柯洁。",
          "2022年OpenAI发布的ChatGPT已具有初步学术论文撰写功能。"
        ]
      }
    ],
    "mustPatterns": [
    ...
    "understandGroups": [
      ...
      },
      {
        "title": "其他缩写",
        "lines": [
          "CAL、CBL、CAE、CAT、CMI、CAPP、EDA等PDF中未加粗的辅助工程缩写只作了解。"
        ]
      },
      {
        "title": "应用举例",
        "lines": [
          "多媒体、网络和人工智能的具体生活应用，以及1997年“深蓝”事件只作了解。"
        ]
      }
    ],
    "understandOnly": [
    ...
    "sourcePdfPath": "./imports/day-12/allround-computer/comp-07-applications.pdf",
    "sourcePdfLabel": "计算机PDF 07 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "只背PDF 07中黑色加粗的应用别名、核心定义、加粗缩写和标志事件。",
      "core": [
        "科学计算又称数值计算，科研和军事是其主要领域，也是计算机最早的应用领域。",
        "数据处理又称非数值计算或事务处理，主要用于商业领域。",
        "过程控制是对压力、液位、流量、温度等参数进行采集与处理的技术。",
  ...
  },
  {
    ...
    "studyMode": "memory",
    "recordType": "知识点背诵",
    "oneLine": "只背PDF 08中黑色加粗的发展方向、新型计算机定义和代表成就。",
    "mustGroups": [
      {
        "title": "发展方向",
        "lines": [
      ...
      },
      {
        "title": "光子与生物计算机",
        "lines": [
          "光子计算机用光子代替电子进行计算和存储，具有超强并行能力和超高速运算速度。",
          "生物计算机又称分子计算机，采用蛋白质分子构成生物芯片，信息以波的形式传播，存储能力巨大。"
        ]
      },
      {
        "title": "量子计算机",
        "lines": [
          "处理和计算量子信息、运行量子算法的装置称为量子计算机。",
          "1993年姚期智证明量子图灵机与量子线路之间存在等价性，为实现量子计算机提供理论基础。"
        ]
      },
      {
        "title": "代表成就",
        "lines": [
          "我国在量子计算机领域处于世界领先地位。",
          "2017年5月，中国科学技术大学潘建伟等人构建出世界上第一台光量子计算机。"
        ]
      }
    ],
    "mustPatterns": [
    ...
    "understandGroups": [
      ...
      },
      {
        "title": "量子原理",
        "lines": [
          "量子比特、态叠加、Hilbert空间、量子纠缠、量子并行和可逆计算的详细解释只作了解。",
          "1982年费曼、1985年杜斯、2020年“九章”等未加粗时间线只作了解。"
        ]
      }
    ],
    "understandOnly": [
    ...
    "sourcePdfPath": "./imports/day-12/allround-computer/comp-08-future.pdf",
    "sourcePdfLabel": "计算机PDF 08 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "只背PDF 08中黑色加粗的发展方向、新型计算机定义和代表成就。",
      "core": [
        "未来计算机将朝着巨型化、微型化、网络化和智能化的方向发展。",
        "光子计算机用光子代替电子进行计算和存储，具有超强并行能力和超高速运算速度。",
        "生物计算机又称分子计算机，采用蛋白质分子构成生物芯片，信息以波的形式传播，存储能力巨大。",
  ...
  },
  {
    ...
    "order": 251,
    "subject": "英语",
    "chapter": "英语｜第三章 非谓语动词｜3.1 不定式、动名词与分词",
    "category": "非谓语动词课堂笔记",
    "range": "非谓语动词课堂笔记 · 第20天 · 8.3",
    "batch": "第20天英语手写课堂笔记｜2026年8月3日",
    "importBatchId": "day-20-2026-08-03-english-handwritten-notes",
    "importDay": 20,
    "importDate": "2026-08-03",
    "importLabel": "第20天 · 8.3",
    "title": "非谓语动词课堂笔记（手写）",
    "oneLine": "整理非谓语动词的形式、语态、时态、固定句型及不定式与动名词的常见搭配。",
    "keywords": [
      "非谓语动词",
      "不定式",
      "动名词",
    ...
    "images": [
      "./imports/day-20/english-handwritten-notes/image1.webp",
      "./imports/day-20/english-handwritten-notes/image2.webp",
      "./imports/day-20/english-handwritten-notes/image3.webp",
      "./imports/day-20/english-handwritten-notes/image4.webp",
      "./imports/day-20/english-handwritten-notes/image5.webp",
      "./imports/day-20/english-handwritten-notes/image6.webp"
    ],
    "sourceFiles": [
      "2026-08-03 用户上传DOCX：7d31a85d-d3eb-4e88-a0ee-a96058577088.docx（英语手写课堂笔记）"
    ],
    "sourceOrg": "未标注",
    "sourceCourse": "用户手写课堂笔记",
    "studyMode": "note",
    "recordType": "英语笔记",
    "mustPatterns": [],
    "basicExplain": [],
    ...
    "importHistory": [
      {
        "id": "day-20-2026-08-03-english-handwritten-notes",
        "day": 20,
        "date": "2026-08-03",
        "label": "第20天 · 8.3",
        "action": "新增英语课堂笔记卡",
        "recordType": "英语笔记",
        "note": "课堂过程型手写资料，只用于理解和查阅，不参与背诵、掌握率或抗遗忘。"
      }
    ],
    "notebookSummary": {
      "overview": "整理非谓语动词的形式、语态、时态、固定句型及不定式与动名词的常见搭配。",
      "core": [
        "非谓语动词基本形式与完成式",
        "不定式作主语、宾语、定语和状语",
        "动名词及固定搭配",
      ...
      "method": [],
      "mistakes": [],
      "conclusion": "非谓语动词基本形式与完成式",
      "mnemonic": "课堂笔记只需理解和查阅，不作为背诵任务。",
      "sourceLabel": "第20天 · 8.3 · 英语笔记 · 未标注来源"
    }
  },
  {
    "id": "D20-ENG-NOTE-002",
    "order": 252,
    "subject": "英语",
    "chapter": "英语｜第二章 动词与时态｜2.1 时态、语态与情态动词",
    "category": "时态与情态动词课堂笔记",
    "range": "时态与情态动词课堂笔记 · 第20天 · 8.3",
    "batch": "第20天英语手写课堂笔记｜2026年8月3日",
    "importBatchId": "day-20-2026-08-03-english-handwritten-notes",
    "importDay": 20,
    "importDate": "2026-08-03",
    "importLabel": "第20天 · 8.3",
    "title": "时态、语态与情态动词课堂笔记（手写）",
    "oneLine": "整理完成时、过去将来时、被动语态、时间标志词和常见情态动词用法。",
    "keywords": [
      "时态",
      "语态",
      "现在完成时",
    ...
    "memoBlocks": [
      {
        ...
        "understanding": [
          ...
          "被动语态结构",
          "情态动词推测与固定句型",
          "used to、be used to等辨析"
        ],
        "mustKnow": []
      }
    ],
    "images": [
      "./imports/day-20/english-handwritten-notes/image7.webp",
      "./imports/day-20/english-handwritten-notes/image8.webp",
      "./imports/day-20/english-handwritten-notes/image9.webp",
      "./imports/day-20/english-handwritten-notes/image10.webp",
      "./imports/day-20/english-handwritten-notes/image11.webp",
      "./imports/day-20/english-handwritten-notes/image12.webp"
    ],
    "sourceFiles": [
      "2026-08-03 用户上传DOCX：7d31a85d-d3eb-4e88-a0ee-a96058577088.docx（英语手写课堂笔记）"
    ],
    ...
    "notebookSummary": {
      "overview": "整理完成时、过去将来时、被动语态、时间标志词和常见情态动词用法。",
      "core": [
        "完成时与时间标志词",
        "过去将来时及相关表达",
        "被动语态结构",
  ...
  },
  {
    ...
    "order": 253,
    "subject": "英语",
    "chapter": "英语｜第二章 动词与时态｜2.2 动词分类与固定用法",
    "category": "动词分类课堂笔记",
    "range": "动词分类课堂笔记 · 第20天 · 8.3",
    "batch": "第20天英语手写课堂笔记｜2026年8月3日",
    "importBatchId": "day-20-2026-08-03-english-handwritten-notes",
    "importDay": 20,
    "importDate": "2026-08-03",
    "importLabel": "第20天 · 8.3",
    "title": "动词分类与固定用法课堂笔记（手写）",
    "oneLine": "整理实义动词、系动词、及物与不及物动词以及常见动词短语和句型。",
    "keywords": [
      "实义动词",
      "系动词",
      "及物动词",
    ...
    "images": [
      "./imports/day-20/english-handwritten-notes/image13.webp",
      "./imports/day-20/english-handwritten-notes/image14.webp"
    ],
    "sourceFiles": [
      "2026-08-03 用户上传DOCX：7d31a85d-d3eb-4e88-a0ee-a96058577088.docx（英语手写课堂笔记）"
    ],
    ...
    "notebookSummary": {
      "overview": "整理实义动词、系动词、及物与不及物动词以及常见动词短语和句型。",
      "core": [
        "实义动词与系动词",
        "及物动词和不及物动词",
        "感官与变化类系动词",
  ...
  },
  {
    ...
    "order": 254,
    "subject": "英语",
    "chapter": "英语｜第一章 基础语法｜介词",
    "category": "介词课堂笔记",
    "range": "介词课堂笔记 · 第20天 · 8.3",
    "batch": "第20天英语手写课堂笔记｜2026年8月3日",
    "importBatchId": "day-20-2026-08-03-english-handwritten-notes",
    "importDay": 20,
    "importDate": "2026-08-03",
    "importLabel": "第20天 · 8.3",
    "title": "介词与介词短语课堂笔记（手写）",
    "oneLine": "系统整理时间、地点、方位、方式、原因、让步和固定搭配中的介词用法。",
    "keywords": [
      "介词",
      "in",
      "on",
    ...
    "memoBlocks": [
      {
        ...
        "understanding": [
          "in、on、at的时间和地点用法",
          "by、for、with等常用介词",
          "during、over、before、after等时间介词",
          "across、through、past等运动介词",
          "方位介词与固定短语",
          "原因、让步和排除关系表达"
        ],
        "mustKnow": []
    ...
    "images": [
      "./imports/day-20/english-handwritten-notes/image15.webp",
      "./imports/day-20/english-handwritten-notes/image16.webp",
      "./imports/day-20/english-handwritten-notes/image17.webp",
      "./imports/day-20/english-handwritten-notes/image18.webp",
      "./imports/day-20/english-handwritten-notes/image19.webp",
      "./imports/day-20/english-handwritten-notes/image20.webp",
      "./imports/day-20/english-handwritten-notes/image21.webp",
      "./imports/day-20/english-handwritten-notes/image22.webp",
      "./imports/day-20/english-handwritten-notes/image23.webp",
      "./imports/day-20/english-handwritten-notes/image24.webp",
      "./imports/day-20/english-handwritten-notes/image25.webp",
      "./imports/day-20/english-handwritten-notes/image26.webp",
      "./imports/day-20/english-handwritten-notes/image27.webp",
      "./imports/day-20/english-handwritten-notes/image28.webp",
      "./imports/day-20/english-handwritten-notes/image29.webp",
      "./imports/day-20/english-handwritten-notes/image30.webp"
    ],
    "sourceFiles": [
      "2026-08-03 用户上传DOCX：7d31a85d-d3eb-4e88-a0ee-a96058577088.docx（英语手写课堂笔记）"
    ],
    ...
    "notebookSummary": {
      "overview": "系统整理时间、地点、方位、方式、原因、让步和固定搭配中的介词用法。",
      "core": [
        "in、on、at的时间和地点用法",
        "by、for、with等常用介词",
        "during、over、before、after等时间介词",
  ...
  },
  {
    ...
    "order": 255,
    "subject": "英语",
    "chapter": "英语｜第一章 基础语法｜形容词与副词",
    "category": "形容词与副词课堂笔记",
    "range": "形容词与副词课堂笔记 · 第20天 · 8.3",
    "batch": "第20天英语手写课堂笔记｜2026年8月3日",
    "importBatchId": "day-20-2026-08-03-english-handwritten-notes",
    "importDay": 20,
    "importDate": "2026-08-03",
    "importLabel": "第20天 · 8.3",
    "title": "形容词与副词课堂笔记（手写）",
    "oneLine": "整理形容词与副词的位置、比较级最高级、词形变化、enough/too和复合形容词。",
    "keywords": [
      "形容词",
      "副词",
      "比较级",
    ...
    "images": [
      "./imports/day-20/english-handwritten-notes/image31.webp",
      "./imports/day-20/english-handwritten-notes/image32.webp",
      "./imports/day-20/english-handwritten-notes/image33.webp",
      "./imports/day-20/english-handwritten-notes/image34.webp"
    ],
    "sourceFiles": [
      "2026-08-03 用户上传DOCX：7d31a85d-d3eb-4e88-a0ee-a96058577088.docx（英语手写课堂笔记）"
    ],
    ...
    "notebookSummary": {
      "overview": "整理形容词与副词的位置、比较级最高级、词形变化、enough/too和复合形容词。",
      "core": [
        "形容词与副词的基本位置",
        "比较级和最高级构成",
        "副词词形与特殊变化",
  ...
  },
  {
    ...
    "importLabel": "第20天 · 8.3",
    "title": "代词与限定词课堂笔记（手写）",
    "oneLine": "整理不定代词、人称与物主代词、反身代词、指示代词、关系代词及数量限定词。",
    "keywords": [
      "代词",
      "不定代词",
      "人称代词",
    ...
    "memoBlocks": [
      {
        ...
        "understanding": [
          "other系列及不定代词",
          "both、either、neither等辨析",
          "all、none、each、every等数量关系",
          "人称、物主、反身和指示代词",
          "it、one、that、those等替代词",
          "关系代词与连接代词"
        ],
        "mustKnow": []
      }
    ...
    "images": [
      "./imports/day-20/english-handwritten-notes/image35.webp",
      "./imports/day-20/english-handwritten-notes/image36.webp",
      "./imports/day-20/english-handwritten-notes/image37.webp",
      "./imports/day-20/english-handwritten-notes/image38.webp"
    ],
    "sourceFiles": [
      "2026-08-03 用户上传DOCX：7d31a85d-d3eb-4e88-a0ee-a96058577088.docx（英语手写课堂笔记）"
    ],
    ...
    "notebookSummary": {
      "overview": "整理不定代词、人称与物主代词、反身代词、指示代词、关系代词及数量限定词。",
      "core": [
        "other系列及不定代词",
        "both、either、neither等辨析",
        "all、none、each、every等数量关系",
  ...
  },
  {
    ...
    "subject": "英语",
    "chapter": "英语｜第一章 基础语法｜名词",
    "category": "名词与数量表达课堂笔记",
    "range": "名词与数量表达课堂笔记 · 第20天 · 8.3",
    "batch": "第20天英语手写课堂笔记｜2026年8月3日",
    "importBatchId": "day-20-2026-08-03-english-handwritten-notes",
    "importDay": 20,
    "importDate": "2026-08-03",
    "importLabel": "第20天 · 8.3",
    "title": "名词与数量表达课堂笔记（手写）",
    "oneLine": "整理可数与不可数名词、数量修饰语、单位词、名词作主语时的主谓一致。",
    "keywords": [
      "名词",
      "可数名词",
      "不可数名词",
    ...
    "images": [
      "./imports/day-20/english-handwritten-notes/image39.webp"
    ],
    "sourceFiles": [
      "2026-08-03 用户上传DOCX：7d31a85d-d3eb-4e88-a0ee-a96058577088.docx（英语手写课堂笔记）"
    ],
    ...
    "notebookSummary": {
      "overview": "整理可数与不可数名词、数量修饰语、单位词、名词作主语时的主谓一致。",
      "core": [
        "可数名词和不可数名词",
        "many、much及数量短语",
        "单位词和量词结构",
  ...
  },
  {
    ...
    "order": 258,
    "subject": "英语",
    "chapter": "英语｜第四章 句法与从句｜4.1 疑问句、从句与基本句型",
    "category": "句法课堂笔记",
    "range": "句法课堂笔记 · 第20天 · 8.3",
    "batch": "第20天英语手写课堂笔记｜2026年8月3日",
    "importBatchId": "day-20-2026-08-03-english-handwritten-notes",
    "importDay": 20,
    "importDate": "2026-08-03",
    "importLabel": "第20天 · 8.3",
    "title": "疑问句、从句与基本句型课堂笔记（手写）",
    "oneLine": "整理一般疑问句、特殊疑问句、选择与反意疑问句、从句连接词及五种基本句型。",
    "keywords": [
      "疑问句",
      "一般疑问句",
      "特殊疑问句",
    ...
    "images": [
      "./imports/day-20/english-handwritten-notes/image40.webp",
      "./imports/day-20/english-handwritten-notes/image41.webp",
      "./imports/day-20/english-handwritten-notes/image42.webp"
    ],
    "sourceFiles": [
      "2026-08-03 用户上传DOCX：7d31a85d-d3eb-4e88-a0ee-a96058577088.docx（英语手写课堂笔记）"
    ],
    ...
    "notebookSummary": {
      "overview": "整理一般疑问句、特殊疑问句、选择与反意疑问句、从句连接词及五种基本句型。",
      "core": [
        "疑问句基本类型",
        "特殊疑问词及句序",
        "从句连接词和句子成分",
  ...
  {
    "id": "D12-COMP-BOLD-009",
    "order": 191.1,
    "subject": "计算机",
    "importDate": "2026-07-26",
    "importDay": 12,
    "importLabel": "第12天 · 7.26",
    "batch": "计算机PDF 01-10规则校正",
    "importBatchId": "computer-pdf-bold-rule-v604",
    "importHistory": [
      {
        "id": "computer-pdf-bold-rule-v604",
        "day": 12,
        "date": "2026-07-26",
        "label": "规则校正",
        "action": "按原PDF粗体重新划分必背与了解",
        "recordType": "知识点背诵"
      }
    ],
    "sourceFiles": [
    ...
    "title": "09 计算思维｜加粗必背",
    "chapter": "计算机｜第一章 计算机基础知识｜1.2 计算思维",
    "category": "09-计算思维",
    "pdfModule": "09-计算思维",
    "pdfSection": "1.2 PDF 09-10",
    "boldOnlyRule": true,
    "studyMode": "memory",
    "recordType": "知识点背诵",
    "oneLine": "只背PDF 09黑色加粗的计算思维概念、本质、四项特征、三个问题和方法总纲。",
    "mustGroups": [
      {
        "title": "基础",
        "lines": [
          "计算是基于规则的符号串变换。",
          "理论思维是推理思维，以推理和演绎为特征，以数学学科为代表。",
          "实验思维是实证思维，以观察和总结自然规律为特征，以物理学科为代表。",
          "计算思维是构造思维，以设计和构造为特征，以计算机学科为代表。"
        ]
      },
      {
        "title": "概念与本质",
        "lines": [
          "计算思维是运用计算机科学的基础概念进行问题求解、系统设计以及人类行为理解的一系列思维活动。",
          "计算思维的本质是抽象和自动化。",
          "抽象离不开形式化和数学建模。",
          "抽象以后就是自动化，抽象是自动化的前提和基础。",
          "计算机通过程序实现自动化，程序的核心是算法。",
          "简单问题的自动化通常分为设计算法和编写程序两步。"
        ]
      },
      {
        "title": "特征",
      ...
      },
      {
        "title": "基本问题",
        "lines": [
          "计算思维的基本问题有可计算性、计算复杂性和图灵测试。",
          "可计算问题可以由计算机在有限步骤内解决。",
          "丘奇-图灵论题认为一切直觉上可计算的函数都可用图灵机计算，反之亦然。",
          "并不是所有问题都可计算。",
          "计算复杂性的度量标准有时间复杂性和空间复杂性。",
          "图灵测试指出了人工智能和机器应达到的智能标准，目前已不能全方位评估人工智能。"
        ]
      },
      {
        "title": "方法与应用",
        "lines": [
          "计算思维的核心是计算思维方法。",
          "计算思维方法分为来自数学和工程的方法、计算机科学独有的方法两大类。",
          "计算思维应用于计算物理学、计算化学、计算生物学、计算经济学和计算机赋能教育。"
        ]
      }
    ],
    "mustPatterns": [
    ...
    "understandGroups": [
      {
        "title": "四种科学范式",
        "lines": [
          "实验范式、理论范式、仿真范式和数据密集型科学发现的详细解释均为浅灰内容，只作了解。"
        ]
      },
      {
        "title": "补充特征",
        "lines": [
          "有限性、确定性、机械性，以及“基础技能、面向所有人”等浅灰说明只作了解。"
        ]
      },
      {
        "title": "七大类方法",
        "lines": [
          "约简、递归、并行、抽象分解、关注分离、冗余容错、启发式推理和时空折中等七类方法的展开说明只作了解。"
        ]
      }
    ],
    "understandOnly": [
    ...
    "sourcePdfPath": "./imports/reference-mindmaps/computer/09-computational-thinking.pdf",
    "sourcePdfLabel": "计算机PDF 09 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "只背PDF 09黑色加粗的计算思维概念、本质、四项特征、三个问题和方法总纲。",
      "core": [
        "计算是基于规则的符号串变换。",
        "理论思维是推理思维，以推理和演绎为特征，以数学学科为代表。",
        "实验思维是实证思维，以观察和总结自然规律为特征，以物理学科为代表。",
  ...
  },
  {
    ...
    "recordType": "了解内容",
    "oneLine": "PDF 10正文没有识别到黑色加粗的必背句，整页保留为了解资料，不参与背诵。",
    "mustGroups": [],
    "mustPatterns": [],
    "understandGroups": [
      {
        "title": "文化",
        "lines": [
          "文化的广义、狭义概念及广泛性、传递性、教育性、深刻性均为普通或浅灰文字，只作了解。"
        ]
      },
      {
        "title": "数字文化",
        "lines": [
          "数字时代、数字文化、数字世界、四次工业革命和数字中国的全部内容只作了解。"
        ]
      },
      {
        "title": "计算机文化与教育",
        "lines": [
          "计算机文化的早期观点、现代定义、计算机能力和计算机文化教育的内容只作了解。"
        ]
      }
    ],
    "understandOnly": [
    ...
    "sourcePdfPath": "./imports/reference-mindmaps/computer/10-computer-culture.pdf",
    "sourcePdfLabel": "计算机PDF 10 原文",
    "sourceOrg": "全方位",
    "boldRuleNote": "严格按原PDF字重分类：黑色加粗内容进入背诵；普通字、浅灰字只用于了解，不进入掌握率和复习排期。",
    "notebookSummary": {
      "overview": "PDF 10正文没有识别到黑色加粗的必背句，整页保留为了解资料，不参与背诵。",
      "core": [],
      "method": [
        "黑色加粗进入背诵。",
        "普通字和浅灰字只阅读了解。"
...
window.KNOWLEDGE_META = {
  ...
  "lightweight": true,
  "lightweightNote": "保持核心背诵块精简；本次仅新增英语手写课堂笔记，不新增背诵知识点、题目或PDF卡。",
  "name": "知识树精简版｜英语课堂笔记独立导入｜不参与背诵",
  "totalCards": 258,
  "notes": [
    ...
    "v54：大型导图改为严格按照原思维导图小标题展开；手机端点击节点后使用全屏详情层，不再上下堆叠导致难以查看。",
    "v55：背诵导图只显示知识点和题目；课堂笔记进入独立页面并标注学科、章、节、知识块、机构和日期。",
    "v55：新增今日复习队列、章节主动回忆、关键词漏点检测和薄弱知识导图；主动回忆记录随学习记录导出导入。",
    "2026年8月3日记录为第20天；本次7页Word中的42张英语手写课堂笔记按内容合并为8张阅读型笔记卡。",
    "本次资料全部归入独立课堂笔记中心，来源标记为“未标注”；不进入今日背诵、知识点导图、掌握率或抗遗忘。",
    "笔记按非谓语动词、时态语态与情态动词、动词分类、介词、形容词副词、代词、名词、句法八个知识块分章；原42张手写图片全部保留。"
  ],
  "chapters": {
    "全部": [
      ...
      "英语｜第二章 动词与时态｜2.1 时态、语态与情态动词",
      "英语｜第二章 动词与时态｜2.2 动词分类与固定用法",
      "英语｜第三章 非谓语动词｜3.1 不定式、动名词与分词",
      "英语｜第四章 句法与从句｜4.1 疑问句、从句与基本句型",
      "英语｜第一章 基础语法｜代词",
      "英语｜第一章 基础语法｜代词与不定代词",
      "英语｜第一章 基础语法｜冠词",
      "英语｜第一章 基础语法｜介词",
  ...
  "importBatches": [
    ...
    },
    {
      ...
      "count": 8,
      "category": "课堂笔记",
      "description": "7页Word共42张英语手写笔记图片，按知识体系合并为8张课堂笔记卡。全部只用于理解和查阅，不新增背诵知识点或题目。",
      "images": [
        "./imports/day-20/english-handwritten-notes/image1.webp",
        "./imports/day-20/english-handwritten-notes/image2.webp",
        "./imports/day-20/english-handwritten-notes/image3.webp",
